...
def gen_normed_ploty(cleaned):
    cleaned["true_10_frac"] /= cleaned.effect_range
    cleaned["true_50_frac"] /= cleaned.effect_range
    cleaned["sam_10_frac"] /= cleaned.effect_range
    cleaned["sam_50_frac"] /= cleaned.effect_range
    fig = make_subplots(rows=1, cols=2)
